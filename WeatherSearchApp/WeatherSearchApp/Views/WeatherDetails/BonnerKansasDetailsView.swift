...
struct BonnerKansasDetailsView: View {
            ...
            VStack(spacing: 20) {
                ...
                if selectedTab == 0 {
                    ...
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible(), spacing: 20), count: 3), spacing: 30) {
                                            WeatherDetailCard(icon: "Wind Speed", label: "Wind Speed", value: "10.00 mph")
                                            WeatherDetailCard(icon: "Pressure", label: "Pressure", value: "30.20 inHg")
                                            WeatherDetailCard(icon: "Precipitation", label: "Precipitation", value: "0%")
                                            WeatherDetailCard(icon: "Temperature", label: "Temperature", value: "25°F")
                                            WeatherDetailCard(icon: "Cloudy", label: "Condition", value: "Cloudy")
                                            WeatherDetailCard(icon: "Humidity", label: "Humidity", value: "49%")
                                            WeatherDetailCard(icon: "Visibility", label: "Visibility", value: "10.00 mi")
                                            WeatherDetailCard(icon: "CloudCover", label: "Cloud Cover", value: "76%")
                                    ...
                                    VStack(spacing: 20) {
                                        WeatherDetailTempChartCard(icon: "Cloudy", label: "Cloudy", value: "25°F")
                                    ...
                                    VStack(spacing: 20) {
                                        VStack(spacing: 10) {
                                            WeatherDetailGaugeChartCard(value1: "0%", value2: "49%:", value3: "100%")
