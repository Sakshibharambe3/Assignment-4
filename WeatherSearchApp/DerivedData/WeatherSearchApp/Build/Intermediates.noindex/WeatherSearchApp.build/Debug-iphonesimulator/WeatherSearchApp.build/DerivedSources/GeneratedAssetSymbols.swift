...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let appIcon1 = DeveloperToolsSupport.ImageResource(name: "App_Icon 1", bundle: resourceBundle)
    ...
    static let windSpeed = DeveloperToolsSupport.ImageResource(name: "Wind Speed", bundle: resourceBundle)

    /// The "addFav" asset catalog image resource.
    static let addFav = DeveloperToolsSupport.ImageResource(name: "addFav", bundle: resourceBundle)

    /// The "plus-circle 1" asset catalog image resource.
    static let plusCircle1 = DeveloperToolsSupport.ImageResource(name: "plus-circle 1", bundle: resourceBundle)

    /// The "removeFav" asset catalog image resource.
    static let removeFav = DeveloperToolsSupport.ImageResource(name: "removeFav", bundle: resourceBundle)
    ...
    static let twitterX = DeveloperToolsSupport.ImageResource(name: "twitter-x", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "App_Icon 1" asset catalog image.
    static var appIcon1: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .appIcon1)
#else
        .init()
#endif
    }
    ...
    /// The "Wind Speed" asset catalog image.
    ...
    /// The "addFav" asset catalog image.
    static var addFav: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .addFav)
#else
        .init()
#endif
    }

    /// The "plus-circle 1" asset catalog image.
    static var plusCircle1: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .plusCircle1)
#else
        .init()
#endif
    }

    /// The "removeFav" asset catalog image.
    static var removeFav: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .removeFav)
#else
        .init()
#endif
    }
    ...
    /// The "twitter-x" asset catalog image.
    static var twitterX: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .twitterX)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "App_Icon 1" asset catalog image.
    static var appIcon1: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .appIcon1)
#else
        .init()
    ...
    /// The "addFav" asset catalog image.
    static var addFav: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .addFav)
#else
        .init()
    ...
    /// The "plus-circle 1" asset catalog image.
    static var plusCircle1: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .plusCircle1)
#else
        .init()
    ...
    /// The "removeFav" asset catalog image.
    static var removeFav: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .removeFav)
#else
        .init()
    ...
    /// The "twitter-x" asset catalog image.
    static var twitterX: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .twitterX)
#else
        .init()
